...
mixin CustomCupertinoRouteTransitionMixin<T> on PageRoute<T> {
  ...
  void didChangePrevious(Route<dynamic>? previousRoute) {
    final String? previousTitleString =
        previousRoute is CustomCupertinoRouteTransitionMixin ? previousRoute.title : null;
...
class _CupertinoEdgeShadowDecoration extends Decoration {
  ...
  static DecorationTween tween(bool withShadow) => DecorationTween(
        begin: const _CupertinoEdgeShadowDecoration._(), // No decoration initially.
          ...
          withShadow
              ? const <Color>[Color(0x00000000), Color(0x00000000), Color(0x00000000), Color(0x00000000)]
              : const [],
        ),
      );
